// Sample code taken from https://github.com/bored-engineer/blowfish.js
...
class Blowfish {
	constructor(key) {
		this.key = key;
		if (this.key.length == 0) throw "0 length key";
		...
		this.key = (this.key.length>56)?this.key.substr(0,56):this.key;	
